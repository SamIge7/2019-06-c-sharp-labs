...
using McMovie_Rick_Anderson_Tutorial.Models;

namespace McMovie_Rick_Anderson_Tutorial.Controllers
{
    public class MoviesController : Controller
    {
        private readonly McMovie_Rick_Anderson_TutorialContext _context;

        public MoviesController(McMovie_Rick_Anderson_TutorialContext context)
        {
            _context = context;
        }
